# Prática – Como usar (Caminhos de Aprendizado)

1. **Objetivo:** Defina o que você quer (APIs, full stack, DevOps, enterprise, plugins, temas).
2. **Grafo:** Consulte [01-grafo-dependencias.md](01-grafo-dependencias.md) para não pular pré-requisitos.
3. **Path:** Escolha um path (1–6) em [02-](02-path-1-2-backend-fullstack.md) a [04-path-5-6-plugin-theme.md](04-path-5-6-plugin-theme.md) e siga a ordem das fases.
